...
export function ThemeDropdown({ theme, onSetTheme }: ThemeDropdownProps) {
  ...
  return (
    <div className="theme-dropdown" ref={ref}>
      ...
      >
        {current && "icon" in current && current.icon === "moon" ? (
          <svg className="theme-dropdown-trigger-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
