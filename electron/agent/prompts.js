...
For editing tasks:
1. Use the file content provided in context (or call read_file if you need it).
2. Make changes with str_replace or write_file.
3. Compile to verify the result.
